...
export function MyStoryPage() {
  ...
  const { data: story, isLoading: storyLoading, error: storyError } = useMyStory(weekCount);
  ...
  return (
    <div className={`max-w-4xl mx-auto px-4 py-8 flex flex-col gap-6 ${transitionClass}`}>
      {/* ── Page Header ── */}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted mt-3 flex items-center gap-1">
                    ...
                    Generated by AI based on your last {weekCount} weeks
                  </p>
                </div>
              </div>
            </section>
