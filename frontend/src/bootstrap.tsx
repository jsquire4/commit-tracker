// bootstrap.tsx — Async entry point for standalone mode.
// Module Federation requires the app entry to be dynamically imported
// so shared dependencies resolve before any module executes.
