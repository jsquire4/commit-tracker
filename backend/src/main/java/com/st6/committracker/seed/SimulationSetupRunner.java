...
import com.st6.committracker.domain.observatory.ObservatoryConfig;
 ...
 * Reads configuration from the file specified by st6.simulation.setup-file.
 *
...
public class SimulationSetupRunner implements ApplicationRunner {
    ...
    @Value("${st6.simulation.setup-file:classpath:simulation-setup.json}")
